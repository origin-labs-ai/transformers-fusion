...
int main(){
 ...
 {
  TransformerConfig cfg; cfg.hidden_size=16; cfg.num_heads=2; cfg.head_dim=8; cfg.num_layers=4; cfg.max_seq_len=16; cfg.ffn_hidden_size=32; cfg.vocab_size=64;
  moe::MoEAllConfig mcfg; mcfg.num_experts=4; mcfg.top_k=2; mcfg.expert_hidden_size=32;
  auto sched=build_hybrid_schedule(4,3);
  TEST_CHECK(sched.num_std==4,"all STD");
 ...
 {
  TransformerConfig cfg; cfg.hidden_size=16; cfg.num_heads=2; cfg.head_dim=8; cfg.num_layers=2; cfg.max_seq_len=16; cfg.ffn_hidden_size=32; cfg.vocab_size=32;
  moe::MoEAllConfig mcfg; mcfg.num_experts=2; mcfg.top_k=1; mcfg.expert_hidden_size=32;
  auto sched=build_hybrid_schedule(2,3);
  TEST_CHECK(sched.num_std==2,"all STD");
  HybridMoeModel model(cfg,mcfg,sched);
