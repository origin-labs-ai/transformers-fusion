...
class GPUComputeWebGPU {
public:
    GPUComputeWebGPU() = default;
    ~GPUComputeWebGPU();
    ...
    // Host reference kernels (REAL CPU, AVX2+scalar, workgroup-256-tuned
    // blocking): verification baseline for CI without Dawn/wgpu hardware.
    // NEVER claimed as WebGPU execution — GPU_WEBGPU compute fails loud.
